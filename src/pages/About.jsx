...
const About = () => {
  return (
    ...
    >
      <h1>About Me</h1>
      <h2>
        <i>Full Stack Developer with Marketing, SEO Expertise</i>
      </h2>
      <p>
        Six months of fullstack development experience working on agile teams.
        Including a web application for a startup in Los Angeles. An ability to
        ...
        planning, crisis management, a demonstrated commitment to customer
        service, and as an accomplished writer with copywriting experience.
      </p>
    </div>
  );
};
